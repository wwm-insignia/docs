...
-  Уничтожить башни/бастионы противника;

   -  Уничтожение каждой башни снижает сопротивление «Гуся» противника;

-  Победить «Гуся»;

-  Доставить дерево противника на свою базу.
...
-  «Аванпосты» *(по соседству с NPC боссами)* \- так же имеют своего босса, после убийства которого команда получает возможность возрождения на этом Аванпосту;

   -  Владение Аванпостом позволяет быстрее развивать атаку на вражескую базу;
