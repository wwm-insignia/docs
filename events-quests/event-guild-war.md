...
-  **Убийство NPC босса**, который находится на Севере и Юге карты - там же находятся Аванпосты;
   ...
   -  Так же убийство босса дает владение над Аванпостом, что открывает возможность команде возрождаться там - это позволяет быстрее развивать атаку на вражескую базу;
